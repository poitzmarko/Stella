...
export const dictionaries = {
  ...
  en: {
    ...
    eventsHint: "Events matched to your stay.",
    phrasesHint: "50 valuable short travel phrases.",
    timelineHint: "The app prioritizes by travel phase.",
    emergencyHint: "Instant access to critical travel info.",
    moneyHint: "Prepared money topics for the road.",
    feedHint:
  ...
  es: {
    ...
    eventsHint: "Eventos según tu estancia.",
    phrasesHint: "50 frases de viaje útiles.",
    timelineHint:
  ...
  fr: {
    ...
    eventsHint: "Événements adaptés à votre séjour.",
    phrasesHint: "50 phrases de voyage utiles.",
    timelineHint:
  ...
  it: {
    ...
    eventsHint: "Eventi adatti al tuo soggiorno.",
    phrasesHint: "50 frasi utili per il viaggio.",
    timelineHint:
  ...
  pt: {
    ...
    eventsHint: "Eventos alinhados com a sua estadia.",
    phrasesHint: "50 frases úteis para viagem.",
    timelineHint:
  ...
  zhHans: {
    ...
    speak: "朗读",
    locationOff: "定位未启用",
    locationHint: "允许 GPS 以查看附近地点和活动。",
    getLocation: "获取位置",
    searchNearby: "附近搜索",
    eventsStay: "停留时长",
    filterAll: "全部",
    ...
    exploreHint:
      "附近最佳地点、隐藏宝藏与旅行亮点。",
    eventsHint: "与你停留时间匹配的活动。",
    phrasesHint: "50 条实用旅行短语。",
    timelineHint:
      "应用会根据旅行阶段优先显示内容。",
    emergencyHint:
      "关键旅行信息的即时访问。",
